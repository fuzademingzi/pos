...
class CambiarCantidadPopup(Popup):
    def __init__(self, data, actualizar_articulo_callback, **kwargs):
        ...
        self.ids.info_nueva_cant_1.font_name = 'SimHei'
        self.ids.info_nueva_cant_2.text = "Cantidad: " + str(self.data['cantidad_carrito'])
        self.ids.info_nueva_cant_2.font_name = 'SimHei'
...
class PagarPopup(Popup):
    def __init__(self, total, pagado_callback, **kwargs):
        ...
        self.ids.total.font_name = 'SimHei'
...
class VentasWindow(BoxLayout):
    ...
    def actualizar_hora(self, *args):
        ...
        self.ids.hora.font_name = 'SimHei'
    ...
    def poner_usuario(self, usuario):
        self.ids.bienvenido_label.text = '欢迎 ' + usuario['nombre']
        self.ids.bienvenido_label.font_name = 'SimHei'
        ...
        if usuario['tipo'] == 'trabajador':
            ...
            self.ids.admin_boton.text = '管理'
            self.ids.admin_boton.font_name = 'SimHei'
